...
[_LOWER] = LAYOUT_planck_grid(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PEQL, KC_P7, KC_P8,   KC_P9,   KC_PMNS,
        KC_DEL,  XXXXXXX, XXXXXXX, KC_HOME, KC_PGUP, XXXXXXX, XXXXXXX, KC_BSPC, KC_P4, KC_P5,   KC_P6,   KC_PPLS,
        KC_LSFT, XXXXXXX, XXXXXXX, KC_END,  KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, KC_P1, KC_P2,   KC_P3,   RSFT_T(KC_PENT),
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______, KC_P0, KC_PDOT, KC_PSLS, KC_PAST
),
...
[_RAISE] = LAYOUT_planck_grid(
        DE_CIRC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        KC_DEL,  DE_PIPE, DE_ACUT, DE_LCBR, DE_LBRC, DE_LPRN, DE_RPRN, DE_RBRC, DE_RCBR, DE_QUOT, DE_DQOT, DE_GRV,
        KC_LSFT, DE_BSLS, KC_HASH, DE_LESS, DE_COLN, DE_UNDS, DE_MINS, DE_SCLN, DE_MORE, DE_TILD, DE_SLSH, RSFT_T(KC_ENT),
